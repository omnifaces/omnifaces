...
/**
 * <p>
 * This {@link ResourceHandler} implementation allows the developer to map Faces resources on an URL pattern of <code>/jakarta.faces.resource/*</code>
 * (basically, the value of {@link ResourceHandler#RESOURCE_IDENTIFIER}) without the need for an additional {@link FacesServlet} prefix or suffix URL pattern in
 * the default produced resource URLs, such as <code>/jakarta.faces.resource/faces/css/style.css</code> or
 * <code>/jakarta.faces.resource/css/style.css.xhtml</code>. This resource handler will produce unmapped URLs like
 * <code>/jakarta.faces.resource/css/style.css</code>. This has the major advantage that the developer don't need the <code>#{resource}</code> EL expression
 ...
 * </pre>
 * <p>
 * This has in turn the advantage that you don't need to modify the background image or font face URLs in CSS files from 3rd party libraries such as Twitter
 * Bootstrap, FontAwesome, etcetera.
 *
 * <h2>Installation</h2>
 * <p>
