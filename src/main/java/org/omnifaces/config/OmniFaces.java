...
@FaceletTagLibrary(
    id = "omnifaces-security", namespace = OmniFaces.OMNIFACES_SECURITY_NAMESPACE, shortName = "sec", description = "OmniFaces Security tag library for jakarta.security.enterprise.SecurityContext authentication and authorization."
)
