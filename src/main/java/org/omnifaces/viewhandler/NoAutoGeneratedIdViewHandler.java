 ...
 * <li>No need to fix the IDs again and again when the client site unit tester encounters an unusable autogenerated ID.
 * <li>Make the developer aware which components are naming containers and/or "require" a fixed ID.
 * </ul>
 * <p>
...
public class NoAutoGeneratedIdViewHandler extends ViewHandlerWrapper {
	...
	public static class NoAutoGeneratedIdResponseWriter extends ResponseWriterWrapper {
		...
		public NoAutoGeneratedIdResponseWriter(ResponseWriter wrapped) {
			this.wrapped = wrapped;
			INTERMEDIATE_ID_PREFIX = getSeparatorChar(getContext()) + UNIQUE_ID_PREFIX;
		}
		...
		public void writeAttribute(String name, Object value, String property) throws IOException {
			...
			if (value != null && "id".equals(name) && isGeneratedID(value.toString())) {
		...
		private boolean isGeneratedID(String value) {
			return value.startsWith(UNIQUE_ID_PREFIX) || value.contains(INTERMEDIATE_ID_PREFIX);
		}
