 ...
 * by {@link EagerBeansRepository#instantiateApplicationScopedAndRegisterListener(javax.servlet.ServletContext)} when
 * any eager session beans or request/view beans by request URI are available.
 *
 * @since 2.0
 * @author Arjan Tijms
 *
