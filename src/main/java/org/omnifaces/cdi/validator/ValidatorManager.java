...
/**
 * <p>
 * The <code>@FacesValidator</code> is by default not eligible for dependency injection by <code>@Inject</code> nor <code>@EJB</code>. It that only when the
 ...
 * {@link FacesValidator} instances eligible for dependency injection <strong>without any further modification</strong>. In order to utilize OmniFaces managed
 * validator, simply remove the Faces native <code>managed=true</code> attribute.
 * <p>
 ...
 * <p>
 * In case you have a {@link FacesValidator} annotated class extending another {@link FacesValidator} annotated class which in turn extends a standard
