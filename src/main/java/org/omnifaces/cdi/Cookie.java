...
/**
 * <p>
 * The CDI annotation <code>&#64;</code>{@link Cookie} allows you to inject a HTTP request cookie value from the current Faces context in a CDI managed bean.
 * It's basically like <code>&#64;ManagedProperty("#{cookie.cookieName.value}") private String cookieName;</code> in a "plain old" Faces managed bean.
 * <p>
