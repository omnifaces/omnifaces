...
public final class ResourcePaths {
	...
	/**
	 * Returns the parent of the given resource path. That is, everything up to but excluding the last occurrence of
	 * {@value #PATH_SEPARATOR}. E.g. input <code>"/foo/bar"</code> will return <code>"/foo"</code>, input
	 * <code>"/foo"</code>, {@value #PATH_SEPARATOR} or an empty string will all return an empty string. This operates
	 * purely on the string representation and is therefore safe to use on URL paths regardless of the underlying
