...
/**
 * <p>
 * Utility class for simplifying some web related tasks that use JNDI under the hood, such as getting the <code>&lt;env-entry&gt;</code> from
 * <code>web.xml</code>.
 * <p>
...
public final class JNDI {
    ...
    /**
     * Returns the named environment entry for the deployment component from where this is called. From within the web module this returns the
     * <code>&lt;env-entry-value&gt;</code> of a <code>&lt;env-entry&gt;</code> in <code>web.xml</code> associated with the given
     * <code>&lt;env-entry-name&gt;</code>.
     * <p>
     ...
     * <code>&lt;lookup-name&gt;</code> should be specified in <code>web.xml</code>.
     *
     * <p>
