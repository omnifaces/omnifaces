...
public final class Hacks {
    ...
    /**
     * Returns true if the given ViewHandler is or wraps Spring WebFlow's org.springframework.faces.webflow.FlowViewHandler. See also
     * https://github.com/omnifaces/omnifaces/issues/952
     *
     * @since 3.14.19
     */
    public static boolean isSpringWebFlowViewHandler(ViewHandler viewHandler) {
        var current = viewHandler;
        ...
        while (current != null) {
            ...
            if (!(current instanceof ViewHandlerWrapper wrapper)) {
                return false;
            }
