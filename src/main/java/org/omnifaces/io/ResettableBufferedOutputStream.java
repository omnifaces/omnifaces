...
/**
 * This resettable buffered output stream will buffer everything until the given threshold buffer size, regardless of flush calls. Only when the specified
 * threshold buffer size is exceeded, or when {@link #close()} is called, then the buffer will be actually flushed.
 * <p>
