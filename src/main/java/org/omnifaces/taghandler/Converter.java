 ...
 * <p>
 * The <code>&lt;o:converter&gt;</code> is currently not compatible with converters which are managed via the
 * <code>managed=true</code> attribute set on the {@link FacesConverter} annotation, at least not when using
