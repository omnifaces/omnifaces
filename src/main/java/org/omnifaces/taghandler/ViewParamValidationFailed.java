...
public class ViewParamValidationFailed extends TagHandler {
    ...
    protected void processViewParamValidationFailed(ComponentSystemEvent event) {
        ...
        if ((component instanceof UIViewParameter ? ((UIViewParameter) component).isValid() : !context.isValidationFailed()) || TRUE.equals(context.getAttributes().put(getClass().getName(), TRUE))) {
