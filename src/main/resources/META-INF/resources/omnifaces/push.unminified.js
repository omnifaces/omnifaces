...
OmniFaces.Push = (function(Util, window) {
	 ...
	 * receive the same push notification from the server. If you want to make the web socket private to a specific user
	 * or group of users, then best is to append an autogenerated identifier to the channel name which identifies the
