...
@Named
@RequestScoped
public class ValidateBeanITDeepNestedClassLevelBean {

    @Valid
    private ValidateBeanITIntermediateEntity intermediate;

    @PostConstruct
    public void init() {
        intermediate = new ValidateBeanITIntermediateEntity();
    }
    ...
    public ValidateBeanITIntermediateEntity getIntermediate() {
        return intermediate;
    }
