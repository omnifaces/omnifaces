...
public class ValidateUniqueColumnIT extends OmniFacesIT {
	 ...
	 */
	@Test
	public void testDuplicateInVisibleRow() {
	 ...
	 */
	@Test
	public void testUniqueChangeIsAccepted() {
		form1Row1Input.clear();
	 ...
	 */
	@Test
	public void testMultipleRowsChangedIntoSameValue() {
	 ...
	 */
	@Test
	public void testDuplicateInPaginatedAwayRow() {
	 ...
	 */
	@Test
	public void testDuplicateWhenOnlyChangedInputIsExecuted() {
	 ...
	 */
	@Test
	public void testDuplicateWhenOtherInputInSameFormIsInvalid() {
	...
	/**
	 * The counterpart of {@link #testDuplicateWhenOtherInputInSameFormIsInvalid()}: a validation failure on an unrelated
	 * input may not cause a duplicate to be reported on rows which are in fact still unique.
	 */
	@Test
	public void testNoFalseDuplicateWhenOtherInputInSameFormIsInvalid() {
	 ...
	 */
	@Test
	public void testDuplicateOnNonAjaxSubmit() {
	...
	/**
	 * The counterpart of {@link #testDuplicateOnNonAjaxSubmit()}: a unique value must still be accepted.
	 */
	@Test
	public void testUniqueChangeOnNonAjaxSubmitIsAccepted() {
