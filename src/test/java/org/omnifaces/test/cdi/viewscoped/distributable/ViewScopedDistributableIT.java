 ...
 */
package org.omnifaces.test.cdi.viewscoped.distributable;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertNotEquals;
import static org.omnifaces.test.OmniFacesIT.WebXml.distributableWithThreeViewsInSession;
...
public class ViewScopedDistributableIT extends OmniFacesIT {
    ...
    public static WebArchive createDeployment() {
        return buildWebArchive(ViewScopedDistributableIT.class)
            .withWebXml(distributableWithThreeViewsInSession)
            .createDeployment();
    }
    ...
    void conditionallyRenderViewScopedIT() {
        open("ViewScopedDistributableITWithConditionalRendering.xhtml");
    ...
    void destroyViewStateWithXhtmlMapping() {
        destroyViewState("ViewScopedDistributableIT.xhtml");
    }

    @Test
    void destroyViewStateWithJsfMapping() {
        destroyViewState("ViewScopedDistributableIT.jsf");
    }

    @Test
    void destroyViewStateWithViewAction() {
        destroyViewState("ViewScopedDistributableITWithViewAction.xhtml");
    }
