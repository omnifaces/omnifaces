 ...
 */
package org.omnifaces.test.cdi.viewscoped.extensionlessdistributable;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertNotEquals;
import static org.omnifaces.test.OmniFacesIT.WebXml.distributableWithThreeViewsInSessionAndExtensionlessMapping;
...
public class ViewScopedExtensionlessDistributableIT extends OmniFacesIT {
    ...
    public static WebArchive createDeployment() {
        return buildWebArchive(ViewScopedExtensionlessDistributableIT.class)
            .withWebXml(distributableWithThreeViewsInSessionAndExtensionlessMapping)
            .createDeployment();
    }
    ...
    void conditionallyRenderViewScopedIT() {
        open("ViewScopedExtensionlessDistributableITWithConditionalRendering");
    ...
    void destroyViewState() {
        destroyViewState("ViewScopedExtensionlessDistributableIT");
    }

    @Test
    void destroyViewStateWithViewAction() {
        destroyViewState("ViewScopedExtensionlessDistributableITWithViewAction");
    }
