...
public class CombinedResourceHandlerIT extends OmniFacesIT {
	...
	private static final String HEAD_COMBINED_SCRIPT_NAME = serializeURLSafe("jakarta.faces:" + (isFaces4Used() ? "faces.js" : "jsf.js") + "|omnifaces:omnifaces.js|headWithTarget.js|bodyWithTargetHead.js");
