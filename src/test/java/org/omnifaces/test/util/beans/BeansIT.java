...
/**
 * The bean manager is obtained only once per web application, which is identified by the context class loader of the
 * request thread. This relies on that class loader being the same object for every request of the same web application,
 * no matter which thread of the pool serves it.
 */
