 ...
 * <pre>
 * &lt;!--[if lte IE 7]&gt;
 *   &lt;link rel="stylesheet" href="#{request.contextPath}/resources/css/ie6-ie7.css" /&gt;
 * &lt;![endif]--&gt;
 * </pre>
 * <p>However, Facelets renders them HTML-escaped and if <tt>javax.faces.FACELETS_SKIP_COMMENTS</tt> context param is
 * set to <code>true</code> then it will even not be rendered at all.
