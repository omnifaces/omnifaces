...
/**
 * <strong>ValidateOrderGt</strong> validates if the values of the given <code>UIInput</code> components are in exactly
 * the same order from greatest to least without duplicates as specified in the <code>components</code> attribute.
 ...
 * @since 1.1
 */
@FacesComponent(ValidateOrderGt.COMPONENT_TYPE)
public class ValidateOrderGt extends ValidateOrder {

	// Public constants -----------------------------------------------------------------------------------------------

	/** The standard component type. */
	public static final String COMPONENT_TYPE = "org.omnifaces.component.validator.ValidateOrderGt";
