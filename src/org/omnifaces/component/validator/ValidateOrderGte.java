...
/**
 * <strong>ValidateOrderGte</strong> validates if the values of the given <code>UIInput</code> components are in exactly
 * the same order from greatest to least, allowing duplicates, as specified in the <code>components</code> attribute.
 ...
 * @since 1.1
 */
@FacesComponent(ValidateOrderGte.COMPONENT_TYPE)
public class ValidateOrderGte extends ValidateOrder {

	// Public constants -----------------------------------------------------------------------------------------------

	/** The standard component type. */
	public static final String COMPONENT_TYPE = "org.omnifaces.component.validator.ValidateOrderGte";
