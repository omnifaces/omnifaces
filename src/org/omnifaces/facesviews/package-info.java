 ...
 * files. As such, it can be used as an alternative to declaring the {@link FacesServlet} in <code>web.xml</code>
 ...
 * </pre>
 * 
 * Note that although the directory outside <code>WEB-INF/faces-views</code> is not scanned, the {@link FacesServlet} 
 ...
 * <table>
 * <tr>
 * <td>{@value FacesViewsInitializerListener#FACES_VIEWS_ENABLE_PARAM_NAME}</td>
 ...
 * Servlet 2.5 users will have to install the {@link FacesViewsForwardingFilter} and {@link FacesViewsViewHandler} manually:
 * <br/>
 * 
 * <p>
 * <b>web.xml</b>
